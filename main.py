...
def detectGesture(landmarks, unit = float) -> int:
  ...
  if distance(landmarks.landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP], landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP]) < 0.3*unit and \
     distance(landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP], landmarks.landmark[mp_hands.HandLandmark.PINKY_TIP]) < 0.4 * unit and \
     distance(landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP], landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP]) > 0.6 * unit and\
     landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_TIP].y < landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_PIP].y and \
     landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_TIP].y < landmarks.landmark[mp_hands.HandLandmark.RING_FINGER_PIP].y:
    return PAUSE

  if landmarks.landmark[mp_hands.HandLandmark.INDEX_FINGER_TIP].y > landmarks.landmark[mp_hands.HandLandmark.INDEX_FINGER_MCP].y and \
